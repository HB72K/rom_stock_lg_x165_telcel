...
CUSTOM_HAL_CAM_CAL = s5k4h5otp s5k5e2frotp
CUSTOM_HAL_COMBO = mt6572_82
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = s5k5e2ya_mipi_raw s5k4h5yx_mipi_raw  s5k5e2fr_mipi_raw  ov2685_mipi_yuv
CUSTOM_HAL_LENS = fm50af fm50af dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = fm50af
CUSTOM_HAL_MAIN_IMGSENSOR = s5k4h5yx_mipi_raw
...
CUSTOM_HAL_SUB_IMGSENSOR = s5k5e2fr_mipi_raw
...
CUSTOM_KERNEL_CAM_CAL = s5k4h5otp s5k5e2frotp
...
CUSTOM_KERNEL_IMGSENSOR = s5k5e2ya_mipi_raw s5k4h5yx_mipi_raw  s5k5e2fr_mipi_raw ov2685_mipi_yuv
CUSTOM_KERNEL_KPD = kpd
#CUSTOM_KERNEL_LCM = hx8379c_fwvga_dsi_vdo
#CUSTOM_KERNEL_LCM = jd9161ba_dsi_vdo  
CUSTOM_KERNEL_LCM = jd9161ba_dsi_vdo hx8379c_fwvga_dsi_vdo 
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = fm50af fm50af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = akm09911
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR = s5k5e2ya_mipi_raw
CUSTOM_KERNEL_MAIN_BACKUP_LENS = fm50af
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5k4h5yx_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = fm50af
CUSTOM_KERNEL_RTC = rtc
CUSTOM_KERNEL_SOUND = amp_6323pmic_spk
CUSTOM_KERNEL_SSW = ssw_single
CUSTOM_KERNEL_SUB_BACKUP_LENS =
CUSTOM_KERNEL_SUB_IMGSENSOR = s5k5e2fr_mipi_raw

CUSTOM_KERNEL_SUB_LENS = dummy_lens
CUSTOM_KERNEL_TOUCHPANEL = ektf2131
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
#CUSTOM_LK_LCM = hx8379c_fwvga_dsi_vdo
#CUSTOM_LK_LCM = jd9161ba_dsi_vdo
CUSTOM_LK_LCM = jd9161ba_dsi_vdo hx8379c_fwvga_dsi_vdo 
CUSTOM_MODEM = arima6582_w_l_hspa
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
#CUSTOM_UBOOT_LCM = hx8379c_fwvga_dsi_vdo
#CUSTOM_UBOOT_LCM = jd9161ba_dsi_vdo
CUSTOM_UBOOT_LCM = jd9161ba_dsi_vdo hx8379c_fwvga_dsi_vdo 
DISABLE_EARPIECE = no
...
MTK_API_CHECK = yes
#<2015/1/30-martin.hu, [V10][Misc][Common][ProjectConfig][][] sync with E12.
MTK_APP_GUIDE = no
#>2015/1/30-martin.hu
...
##//<2015/03/25-Yuting Shih. Masked if non-support in USB computer connection menu.
# MTK_BICR_SUPPORT = yes
MTK_BICR_SUPPORT = no
##//>2015/03/25-Yuting Shih.
MTK_BIP_SCWS = yes
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L0.MP2.V1_ARIMA6582.W.L_P80
MTK_BWC_SUPPORT = yes
...
#<2015/3/26-JichangDu, [V10][Porting][Common][CMAS][][]Porting cmas function of chile version.
...
#//<2015/2/13-davidda, [V10][Misc][Common][ProjectConfig][][] Disable power on/off voltage limitation
#//<2015/2/12-Dongshilei, [V10][Misc][Common][ProjectConfig][][] Enable power on/off voltage limitation
#//<2015/2/7-Dongshilei, [V10][Misc][Common][ProjectConfig][][] Disable power on/off voltage limitation
MTK_DISABLE_POWER_ON_OFF_VOLTAGE_LIMITATION = yes
#//>2015/2/7-Dongshilei
#//>2015/2/12-Dongshilei
#//>2015/2/13-davidda
...
#>2015/1/30-martin.hu
#//<2015/1/13-davidda, [V10][Feature][Common][BSP][]enable RT9536
MTK_RT9536_SUPPORT = yes
#//>2015/1/13-davidda
...
#//<2015/04/15-daisy.zang,[V10][Feature][Common][WiFi][][EUOPENREQ-405]TLF Group (TLF ES, O2 UK, O2 DE)] Wi-Fi Hotspot 2.0  Release 2
#ALPS02033451
MTK_PASSPOINT_R1_SUPPORT = no
MTK_PASSPOINT_R2_SUPPORT = yes
#//>2015/04/15-daisy.zang
...
#//<2015/4/J0008/22-JamesZhou, [V10][Feature][Common][CDS][][]Remove PPL APK.
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt6582
MTK_RILD_READ_IMSI = no
MTK_RSDM_APP = no
MTK_RTP_OVER_RTSP_SUPPORT = yes
MTK_RTSP_BITRATE_ADAPTATION_SUPPORT = no
#//<2015/4/14-raoruilong, [v10][Porting][Common][audio][][]Connecting earjack,make it level under 85dB 
MTK_SAFEMEDIA_SUPPORT = yes
#//<2015/4/14-raoruilong
MTK_SCOMO_ENTRY = no
...
#//<2015/4/7-LindaGuo, [V10][Porting][Common][Protocol][TD][4197]The behavior is incorrect after the phone received ACTIVATE CONTEXT REJECT message.
...
#<2015/3/2-Dongshilei, [V10][Misc][Common][ProjectConfig][][] Disable MTK_TTY_SUPPORT.
MTK_TTY_SUPPORT = no
#>2015/3/2-Dongshilei
...
#CREATE_PROJECT_INFO=20141215195930

#Arima add
#//<2015/1/16-rickjiau, enable USB ACM to turn on AT command.
MTK_SERIAL_PORT_DEFAULT_ON = yes
#//>2015/1/16-rickjiau
V10_HW = yes
#<2015/3/5-martin.hu, [V10][Misc][Common][ProjectConfig][][] add a prop to use in a compile time.
V10_CUSTOMIZATION_VESION=Mexico_Telcel
#>2015/3/5-martin.hu

## //<2015/01/20-Yuting Shih. [V10][Feature][Common][BSP][][] Add for the LGE united USB driver.
CONFIG_LGE_USB_DRIVER           = yes
CONFIG_LGE_USB_DIAG_COMPOSITE   = yes
CONFIG_LGE_CABLE_ID_DETECT      = yes

CONFIG_USB_G_LGE_ANDROID          = yes
CONFIG_USB_G_LGE_ANDROID_AUTORUN  = yes
CONFIG_USB_G_LGE_MULTIPLE_CONFIGURATION = yes
## //>2015/01/20-Yuting Shih.
